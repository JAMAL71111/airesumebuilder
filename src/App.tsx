                ...
                <div className="cv-print-main-row flex flex-row w-full min-h-[900px] print:min-h-0 print:h-full bg-white print:overflow-hidden print:flex-grow">
                  ...
                  <aside className="w-[35%] bg-[#1A2B3C] text-white p-8 flex flex-col gap-8 print:gap-4 print:p-4 print:w-[35%] print:h-full" style={{ WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
                    ...
                    <div className="space-y-4 text-sm font-light print:space-y-2 print:text-xs">
                      {address && (
                        <div>
                          <h3 className="text-lg font-bold text-white mb-1 uppercase print:mb-0 print:text-base">ADDRESS</h3>
                          <span className="text-slate-100">{address}</span>
                        </div>
                      )}
                      {phone && (
                        <div>
                          <h3 className="text-lg font-bold text-white mb-1 uppercase print:mb-0 print:text-base">Mobile</h3>
                          <span className="text-slate-100 block">{phone}</span>
                        </div>
                      )}
                      {email && (
                        <div>
                          <h3 className="text-lg font-bold text-white mb-1 uppercase print:mb-0 print:text-base">Email</h3>
                    ...
                    {languages && (
                      <div>
                        <h3 className="text-lg font-bold text-white mb-2 uppercase print:mb-1 print:text-base">Language</h3>
                        <div className="text-sm font-light text-slate-100 whitespace-pre-line leading-relaxed print:text-xs print:leading-normal">{languages}</div>
                      </div>
                    )}

                    {socialMedia && (
                      <div>
                        <h3 className="text-lg font-bold text-white mb-2 uppercase print:mb-1 print:text-base">Social Media</h3>
                        <div className="text-sm font-light text-slate-100 whitespace-pre-line break-all leading-relaxed print:text-xs print:leading-normal">{socialMedia}</div>
                      </div>
                    )}
                  </aside>
                            ...
                            {skills.split('\n').map((skill, index) => {
                              ...
                              return (
                                <div key={index} className="flex justify-between items-center mb-2 print:mb-1">
                                  <span className="text-slate-700 text-xs font-bold uppercase tracking-wide w-1/2 print:text-[10px]">{skill.trim()}</span>
