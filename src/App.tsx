...
// ==========================================
// 1. قسم البيانات (المقالات)
// ملاحظة: قمت بتقليلها هنا لـ 3 مقالات لسرعة الكود. 
// يمكنك مستقبلاً نقل هذه المصفوفة إلى ملف باسم data.ts واستدعائها هنا.
// ==========================================
const articlesData = [
  {
    id: 1,
    title: 'كيفية كتابة سيرة ذاتية احترافية في 2024',
    excerpt: 'تعرف على أهم النصائح لكتابة سيرة ذاتية تجذب انتباه مديري التوظيف...',
    content: 'هنا يكتب المحتوى الكامل للمقال الأول. السيرة الذاتية هي بوابتك الأولى للحصول على الوظيفة...',
    date: '2024-01-15'
  },
  {
    id: 2,
    title: 'أخطاء شائعة يجب تجنبها في مقابلات العمل',
    excerpt: 'تجنب هذه الأخطاء القاتلة التي قد تكلفك الوظيفة التي تحلم بها...',
    content: 'هنا يكتب المحتوى الكامل للمقال الثاني. من أهم الأخطاء عدم التحضير الجيد للمقابلة...',
    date: '2024-01-20'
  },
  {
    id: 3,
    title: 'أهم المهارات المطلوبة في سوق العمل الحالي',
    excerpt: 'اكتشف المهارات التي يبحث عنها أصحاب العمل لتعزيز فرصك...',
    content: 'هنا يكتب المحتوى الكامل للمقال الثالث. المهارات الناعمة مثل التواصل وحل المشكلات أصبحت بأهمية المهارات التقنية...',
    date: '2024-01-25'
  }
];

// ==========================================
// 2. مكونات الصفحات (Pages Components)
// ==========================================
...
// --- صفحة اتصل بنا (تم تحديثها ببريدك الإلكتروني) ---
const ContactPage = () => (
    ...
    <div className="bg-white p-8 rounded-xl shadow-md space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8">
        ...
        <div className="flex flex-col items-center p-6 bg-green-50 rounded-xl flex-1 border border-green-100">
          ...
          <a href="https://wa.me/رقم_هاتفك_هنا" target="_blank" rel="noreferrer" className="text-green-600 hover:underline">
            اضغط هنا للمراسلة
          </a>
        </div>
      </div>
...
// ==========================================
// 3. المكون الرئيسي (Main App Component)
// ==========================================
